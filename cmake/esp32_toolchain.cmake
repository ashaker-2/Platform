...
set(TOOLCHAIN_PATH "/c/Users/161790/Downloads/Project/xtensa-esp32-elf")

# This is the magic line — must be before 'project()'
...
set(CMAKE_C_FLAGS        "-mlongcalls -mtext-section-literals -falign-functions=16 -std=gnu11" CACHE STRING "" FORCE)
set(CMAKE_CXX_FLAGS      "-mlongcalls -mtext-section-literals -falign-functions=16 -std=gnu++11" CACHE STRING "" FORCE)
...
#     "-nostdlib -Wl,--gc-sections -Wl,--cref -Wl,--defsym=__ESP32_FLASH_SIZE=4M -Wl,-Map=${CMAKE_BINARY_DIR}/${PROJECT_NAME}.map -T${ESP32_LINKER_SCRIPT}"
# )
...
include_directories(BEFORE #The BEFORE makes these directories take priority over other system paths.
   "${TOOLCHAIN_PATH}/xtensa-esp32-elf/sys-include"
   "${TOOLCHAIN_PATH}/xtensa-esp32-elf/include"
)
