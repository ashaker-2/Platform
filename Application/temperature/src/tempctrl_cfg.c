...
const TempCtrl_SensorConfig_t tempctrl_sensor_configs[TempCtrl_SENSOR_COUNT] = {
    ...
    {.id = TempCtrl_SENSOR_ID_HEATER_EXHAUST, .type = TempCtrl_SENSOR_TYPE_ANALOG_ADC, .comm_details.analog_adc = {.adc_channel = MCAL_ADC_CHANNEL_5}, .calibration_slope = 0.5f, .calibration_offset = -10.0f, .read_delay_ms = 10},
