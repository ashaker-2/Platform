...
const HAL_SPI_ChannelConfig_t g_hal_spi_channel_configs[HAL_SPI_CHANNEL_MAX] = {
    [HAL_SPI_CHANNEL_0] = {
        ...
        .mosi_pin = 23,          // Example: GPIO23 for MOSI
        .miso_pin = 19,          // Example: GPIO19 for MISO
        .sclk_pin = 18,          // Example: GPIO18 for SCLK
    ...
    [HAL_SPI_CHANNEL_1] = {
        ...
        .data_bits = HAL_SPI_DATA_BITS_8, // Example: 8-bit data
        .master_mode = true,              // Operating as master
        .mosi_pin = 27,          // Example: GPIO27 for MOSI
        .miso_pin = 26,          // Example: GPIO26 for MISO
        .sclk_pin = 25,          // Example: GPIO25 for SCLK
        // .txrx_cplt_callback = NULL,       // No default callback, set during IT transfer
    },
