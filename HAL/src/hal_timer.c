...
// #include "timer.h"      // ESP-IDF Timer driver
...
typedef struct
{
    ...
    HAL_TIMER_Channel_t timer_group;     /**< ESP-IDF Timer Group. */
    HAL_TIMER_Channel_t timer_idx;         /**< ESP-IDF Timer Index within the group. */
 ...
 */
static bool hal_timer_map_channel_to_esp_timer(HAL_TIMER_Channel_t channel, HAL_TIMER_Channel_t *group, HAL_TIMER_Channel_t *idx)
{
    // switch (channel)
    // {
