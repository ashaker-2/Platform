...
/*
 * This header provides PRIuSIZE, a printf formatter macro for uint16_t which is similar to the macros
 * PRIuX defined in inttypes.h. It is necessary because uint16_t has different width on different
