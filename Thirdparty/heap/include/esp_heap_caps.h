 ...
 */
typedef void (*esp_alloc_failed_hook_t) (uint16_t size, uint32_t caps, const char * function_name);
 ...
 */
__attribute__((weak)) HEAP_IRAM_ATTR void esp_heap_trace_alloc_hook(void* ptr, uint16_t size, uint32_t caps);
 ...
 */
void *heap_caps_malloc(uint16_t size, uint32_t caps);
 ...
 */
void *heap_caps_realloc( void *ptr, uint16_t size, uint32_t caps);
 ...
 *
 */
void *heap_caps_aligned_alloc(uint16_t alignment, uint16_t size, uint32_t caps);
 ...
 *
 */
void *heap_caps_aligned_calloc(uint16_t alignment, uint16_t n, uint16_t size, uint32_t caps);
 ...
 * @return A pointer to the memory allocated on success, NULL on failure
 */
void *heap_caps_calloc(uint16_t n, uint16_t size, uint32_t caps);
...
uint16_t heap_caps_get_total_size(uint32_t caps);
 ...
 */
uint16_t heap_caps_get_free_size( uint32_t caps );
 ...
 * @return Amount of free bytes in the regions
 */
uint16_t heap_caps_get_minimum_free_size( uint32_t caps );
 ...
 */
uint16_t heap_caps_get_largest_free_block( uint32_t caps );
 ...
 */
void heap_caps_malloc_extmem_enable(uint16_t limit);
 ...
 * @return A pointer to the memory allocated on success, NULL on failure
 */
void *heap_caps_malloc_prefer( uint16_t size, uint16_t num, ... );
 ...
 */
void *heap_caps_realloc_prefer( void *ptr, uint16_t size, uint16_t num, ... );
 ...
 * @return A pointer to the memory allocated on success, NULL on failure
 */
void *heap_caps_calloc_prefer( uint16_t n, uint16_t size, uint16_t num, ... );
 ...
 *
 */
uint16_t heap_caps_get_allocated_size(void *ptr);
 ...
 *
 */
uint16_t heap_caps_get_containing_block_size(void *ptr);
