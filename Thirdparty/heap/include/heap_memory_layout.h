...
extern const uint16_t soc_memory_type_count;
...
typedef struct {
    ...
    uint16_t size;            ///< Size of the region in bytes
    uint16_t type;            ///< Type of the region (index into soc_memory_types array)
...
extern const uint16_t soc_memory_region_count;
 ...
 */
uint16_t soc_get_available_memory_regions(soc_memory_region_t *regions);
 ...
 */
uint16_t soc_get_available_memory_region_max_count(void);
